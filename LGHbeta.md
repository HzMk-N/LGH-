...
UtilityTab:CreateButton({
   ...
   Callback = function()
      if userFrame then
         ...
         Rayfield:Notify({
            Title = "Teleportica",
            Content = userFrame.Visible and "TP on" or "TP off",
            Duration = 3,
         })
      else
         Rayfield:Notify({Title = "error", Content = "Don't see Teleportica", Duration = 4})
      end
   end,
})
...
Rayfield:Notify({
   Title = "LGH Loaded, Teleporters often malfunction.",
   Content = "LGH v1.1",
   Duration = 6,
})
